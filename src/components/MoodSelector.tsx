...
const MOODS: MoodOption[] = [
  { id: 1, name: 'sad',      avatar: '/assets/Onboarding-2/avatar/sad.png',      floral: '/assets/Onboarding-2/floral/fasd.png',      label: 'Sad'      },
  { id: 2, name: 'happy',    avatar: '/assets/Onboarding-2/avatar/happy.png',    floral: '/assets/Onboarding-2/floral/fhappy.png',    label: 'Happy'    },
  { id: 3, name: 'cry',      avatar: '/assets/Onboarding-2/avatar/cry.png',      floral: '/assets/Onboarding-2/floral/fcry.png',      label: 'Cry'      },
  { id: 4, name: 'confused', avatar: '/assets/Onboarding-2/avatar/confused.png', floral: '/assets/Onboarding-2/floral/fconfused.png', label: 'Confused' },
  { id: 5, name: 'angry',    avatar: '/assets/Onboarding-2/avatar/angry.png',    floral: '/assets/Onboarding-2/floral/fangry.png',    label: 'Angry'    },
]
