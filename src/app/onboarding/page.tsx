...
const companions = [
  { id: 1, name: 'Zen Master', unlocked: true, image: '/assets/zen_onbd.png' },
  { id: 2, name: 'Night Wolf', unlocked: false, image: '/assets/zen_onbd.png' },
  { id: 3, name: 'Wise Tiger', unlocked: false, image: '/assets/zen_onbd.png' },
  { id: 4, name: 'Happy Frog', unlocked: false, image: '/assets/zen_onbd.png' },
]
