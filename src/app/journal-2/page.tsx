...
const activities: Activity[] = [
  { id: 'work', icon: '/assets/journal/journal-2/material-symbols_work-sharp.png', label: 'Work' },
  { id: 'pet', icon: '/assets/journal/journal-2/Vector.png', label: 'Pet' },
  { id: 'blender', icon: '/assets/journal/journal-2/ic_baseline-blender.png', label: 'Shld' },
  { id: 'camera', icon: '/assets/journal/journal-2/Vector (3).png', label: 'Shvld' },
  { id: 'party', icon: '/assets/journal/journal-2/material-symbols_sports-bar-rounded.png', label: 'Party' },
  { id: 'jogging', icon: '/assets/journal/journal-2/Vector (1).png', label: 'Jogging' },
  { id: 'agriculture', icon: '/assets/journal/journal-2/ic_baseline-agriculture.png', label: 'Shldshld' },
  { id: 'castle', icon: '/assets/journal/journal-2/ic_baseline-castle.png', label: 'Shld' },
]
