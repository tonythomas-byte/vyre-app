...
const MOODS: MoodOption[] = [
  { id: 1, name: 'sad',      avatar: '/assets/illustrations/onboarding/avatar/sad.png',      floral: '/assets/illustrations/onboarding/floral/fasd.png',      label: 'Sad'      },
  { id: 2, name: 'happy',    avatar: '/assets/illustrations/onboarding/avatar/happy.png',    floral: '/assets/illustrations/onboarding/floral/fhappy.png',    label: 'Happy'    },
  { id: 3, name: 'cry',      avatar: '/assets/illustrations/onboarding/avatar/cry.png',      floral: '/assets/illustrations/onboarding/floral/fcry.png',      label: 'Cry'      },
  { id: 4, name: 'confused', avatar: '/assets/illustrations/onboarding/avatar/confused.png', floral: '/assets/illustrations/onboarding/floral/fconfused.png', label: 'Confused' },
  { id: 5, name: 'angry',    avatar: '/assets/illustrations/onboarding/avatar/angry.png',    floral: '/assets/illustrations/onboarding/floral/fangry.png',    label: 'Angry'    },
]
...
const FLORAL_BASE     = 85    // px — size at center slot
...
export default function MoodSelector({ onMoodSelect, onFirstSwipe }: MoodSelectorProps) {
  ...
  const floralItemStyle = (
    ...
    const slotKey = offset.toString() as '-2' | '-1' | '0' | '1' | '2'
